Rails.application.routes.draw do
  ...
  put "application_requests/:application_request_id/accept", to: "application_requests#accept", as: "accept"
  put "application_requests/:application_request_id/decline", to: "application_requests#decline", as: "decline"
end
